...
if(!empty($_POST['email']) && !empty($_POST['numero'])){
    ...
    $req = $db->query("SELECT * FROM etudiant WHERE EMAIL_ETU=$email AND NUMERO_ETU=$numero");
    $user = $req->fetch();
...
if($usertype=="etudiant"){
  ...
  $_SESSION['numero']=$user['NUMERO_ETU'];
  $_SESSION['email']=$user['EMAIL_ETU'];
  $_SESSION['adresse']=$user['ADRESSE_ETU'];

  header('Location:/gesion_soutenance/Site/acount.php');
  exit();
}
  ...
  <body>  
    ...
    <div class="header">    
      ...
      <nav class="navbar navbar-default main-navigation" role="navigation">
        ...
        <a class="navbar-nav logo" href="index.html"><img src="assets/img/logo.png" alt=""></a>
        <div class="container">
              ...
              <form role="form" method="POST" action="login.php" class="login-form">
                ...
                <div class="form-group">
                  <div class="input-icon">
                    ...
                    <input type="password" class="form-control" name="numero" placeholder="numero">
                  </div>
                </div>                  
                <div class="checkbox">
                ...
                <button type="submit" class="btn btn-common log-btn">Connecter</button>
              </form>
              <ul class="form-links">
                <li class="pull-right"><a href="forgot-password.html">Mot de passe oublié ?</a></li>
              </ul>
            </div>
          </div>
        </div>
      ...
      <div class="container">
        <div class="row text-center">
            <div class="error-page">
              <h2><a  href="#"></br>Gestion des soutenances</a></h2>
          </div>
        </div>
      </div>
