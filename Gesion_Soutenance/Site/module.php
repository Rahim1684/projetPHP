...
<?php 
      ...
      try{
        ...
        if(isset($_POST['titre']) && isset($_POST['niveau'])){

            $titre = $db->quote($_POST['titre']);
            $niveau = $db->quote($_POST['niveau']);
            
                      
            $db->query("INSERT INTO module SET  NOM_MOD=$titre, NIVEAU=$niveau");
            header('Location:/gesion_soutenance/Site/module.php');
         ...
         <div class="col-sm-8 r">
            <div class="inner-box">
                <form method="POST" action="module.php">
                  ...
                  <h5 class="" id="">Ajouter un module</h5>
                      <label for="message-text" class="col-form-label">Nom du module :</label>
                  ...
                  <div class="custom-file">
                      ...
                      <input type="text" class="form-control" id="" name="niveau" aria-describedby="" placeholder="Licence 1,Licence 2....">
                    </div>
