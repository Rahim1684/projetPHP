  ...
  <body>  
        ...
        <div class="container">
          ...
          <div class="collapse navbar-collapse" id="navbar">
            <ul class="nav navbar-nav navbar-right">
              <li class="postadd">
                <a class="btn btn-light btn-post" href=""><span class="lnr lnr-enter"></span> S'inscrire</a>
              </li>
              <li class="postadd">
                <a class="btn btn-light btn-post" href="login.html"><span class="lnr lnr-user"></span> Se connecter</a>
              </li>
            </ul>
          </div>
          <!-- Navbar End -->
    ...
    <section id="intro" class="section-intro">
      <div class="overlay">
        <div class="container">
          <div class="main-text">
            <h1 class="intro-title">Bienvenu dans notre <span style="color: #3498DB">Site</span></h1>
